...
const ITEMS: SphereItem[] = [
  ...
  },
  {
    ...
    description: "A candid snapshot where the world seems to pause. The subject is isolated against a blurred background, highlighting a personal narrative amidst the chaos.",
  ...
  },
  {
    ...
    description: "Misty horizons and soft gradients create a sense of depth. The viewer is invited to look beyond the immediate and into the infinite distance.",
  ...
  },
  {
    ...
    description: "Sharp lines meet organic textures. A high-contrast study that brings out the hidden geometry in the everyday environment.",
