...
const ITEMS: SphereItem[] = [
  {
    ...
    description: "A high-contrast silhouette captured against a warm gradient. The composition balances negative space with the subject, while the golden hour lighting defines the edges with a soft, rim-light effect.",
  ...
  },
  {
    ...
    title: "Urban Echoes",
    description: "Vertical lines and concrete textures interact with natural light. The repetition of forms creates a rhythmic geometry, broken only by the dynamic shadows of the transient figures.",
  ...
  },
  {
    ...
    title: "Evening Calm",
    description: "A long-exposure study of the blue hour. The wide aperture of f/1.7 allows for sufficient light capture without introducing noise, rendering the stillness of the evening with a painterly softness.",
  ...
  },
  {
    ...
    description: "A minimal landscape utilizing the rule of thirds. The vast negative space of the sky contrasts effectively with the grounded horizon line, emphasizing scale and isolation.",
  ...
  },
  {
    ...
    description: "Symmetrical composition centering on the reflection. The fluid distortion of the water surface adds an abstract quality, mirroring the sky's mood with sharp clarity.",
  ...
  },
  {
    ...
    description: "Rich saturation and textural depth define this macro shot. The shallow depth of field (f/1.9) isolates the foreground growth while blurring the verdant background into soft bokeh.",
  ...
  },
  {
    ...
    description: "Hard light creates strong shadows and high contrast here. The stopped-down aperture maintains sharpness, turning mundane objects into a study of geometry and form.",
  ...
  },
  {
    ...
    title: "Night Mode",
    description: "Low-light street photography pushing ISO 1200. The slight motion blur from the 1/15s shutter conveys the kinetic energy of city nightlife against static neon elements.",
  ...
  },
  {
    ...
    title: "Steel Giants",
    description: "Low-angle perspective emphasizes the scale of the architecture. Leading lines of steel draw the eye upward, highlighting the juxtaposition of industrial rigidity and open sky.",
  ...
  },
  {
    ...
    description: "Soft lighting and cloud textures create an ethereal atmosphere. The 1/800s shutter speed freezes the motion of the clouds, preserving their precise structure against the blue.",
  ...
  },
  {
    ...
    title: "Street Candid",
    description: "A decisive moment captured with a shallow f/1.8 depth of field. The subject is perfectly isolated from the chaotic background, freezing a split-second narrative.",
  ...
  },
  {
    ...
    description: "Macro analysis of leaf venation. The diffuse lighting eliminates harsh shadows, revealing the intricate fractal patterns and biological engineering of the surface.",
  ...
  },
  {
    ...
    title: "Shadow Play",
    description: "Chiaroscuro effect achieved through high-contrast lighting. The deliberate heavy shadows obscure detail to focus attention entirely on the illuminated forms.",
  ...
  },
  {
    ...
    title: "Quiet Corner",
    description: "Interior architectural study using available light. The ISO 800 sensitivity captures the ambient warmth without flash, preserving the intimate atmosphere of the space.",
  ...
  },
  {
    ...
    title: "Neon Nights",
    description: "Cyberpunk aesthetic defined by saturated neon hues. The wide f/1.8 aperture captures the available light, allowing the colors to bleed into the wet surfaces for a cinematic feel.",
  ...
  },
  {
    ...
    title: "Glass & Water",
    description: "Refraction and distortion are the focus. The interaction of light through glass creates a surreal, inverted reality, challenging the viewer's perception of the object.",
  ...
  },
  {
    ...
    title: "Macro World",
    description: "Extreme close-up revealing textures invisible to the naked eye. The very shallow depth of field at f/2.4 creates a dreamlike quality, abstracting the granular details.",
  ...
  },
  {
    ...
    title: "Leading Lines",
    description: "Strong geometric composition where converging lines guide the eye. The perspective depth is enhanced by the f/2.2 aperture, drawing focus straight to the vanishing point.",
  ...
  },
  {
    ...
    description: "A study in minimalism and negative space. The lone subject is balanced against a vast, unblemished sky, creating a powerful sense of solitude and scale.",
  ...
  },
  {
    ...
    description: "A perfectly centered composition exploring reflection and balance. The geometric precision provides a sense of visual order and harmony amidst the chaos.",
  ...
  },
  {
    ...
    title: "Captive Moment",
    description: "Portraiture utilising natural light. The subject's expression is the focal point, separated from the background by a smooth bokeh owed to the f/1.8 aperture.",
    settings: "ISO 200 • f/1.8 • 1/400s"
  },
  {
    id: 21,
    ...
    description: "Landscape layering created by atmospheric haze. The receding planes of the scenery fade into lighter values, creating a strong sense of aerial perspective.",
    settings: "ISO 320 • f/2.2 • 1/200s"
  },
  {
    id: 22,
    ...
    title: "Structured Contrast",
    description: "High-contrast monochrome architectural shot. The hard lines and deep shadows emphasize the structural integrity and abstract geometry of the built environment.",
    settings: "ISO 100 • f/4.0 • 1/125s"
  }
];
